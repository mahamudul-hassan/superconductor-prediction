...
d = np.load('artifacts/pool_tuned.npz')
...
ax.scatter(y_pool, pred_raw_pool, s=6, alpha=0.35, color='#4C72B0', linewidths=0)
...
ax.set_title(f'Parity plot, leak-free held-out set\n$R^2$={r2:.3f}, MAE={mae:.2f} K')
plt.tight_layout()
